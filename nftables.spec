...
Source0  : https://www.netfilter.org/pub/nftables/nftables-1.0.8.tar.xz
Source1  : https://www.netfilter.org/pub/nftables/nftables-1.0.8.tar.xz.sig
...
%prep
%setup -q -n nftables-1.0.8
cd %{_builddir}/nftables-1.0.8
pushd ..
cp -a nftables-1.0.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697575282
...
mv %{buildroot}/usr/lib/python3.12/site-packages/nftables-0.*-py3.12.egg/nftables %{buildroot}/usr/lib/python3.12/site-packages/
## install_append end
