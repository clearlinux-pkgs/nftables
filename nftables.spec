...
%prep
%setup -q -n nftables-0.9.7
cd %{_builddir}/nftables-0.9.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1605923597
...
cp %{_builddir}/nftables-0.9.7/COPYING %{buildroot}/usr/share/package-licenses/nftables/18fa48a7ed581b147776213368ae1aafd82509c2
%make_install
