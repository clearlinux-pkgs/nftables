...
Source0  : https://www.netfilter.org/pub/nftables/nftables-1.1.3.tar.xz
Source1  : https://www.netfilter.org/pub/nftables/nftables-1.1.3.tar.xz.sig
...
%setup -q -n nftables-1.1.3
cd %{_builddir}/nftables-1.1.3
pushd ..
cp -a nftables-1.1.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745330947
